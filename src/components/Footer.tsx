    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="bg-gray-800 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400 mb-6">Our support team is available 24/7 to help you succeed</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              SlCubeTechSolutions is your ultimate platform for placement preparation, competitive exams, and interview success. Join thousands of students achieving their career goals.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#" className="hover:text-white transition-colors">Placement Courses</a>
              </li>
              <li>
                <a href="#" className="hover:text-white transition-colors">Interview Prep</a>
              </li>
              <li>
                <a href="#" className="hover:text-white transition-colors">Competitive Exams</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>support@SlCubeTechSolutions.com</span>
              </li>
              <li className="flex items-start gap-2">
